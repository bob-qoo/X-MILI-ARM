...
[![GitHub](https://img.shields.io/badge/GitHub-X--MILI-black?style=for-the-badge&logo=github)](https://github.com/bob-qoo/X-MILI-ARM)
...
```bash
bash <(curl -Ls https://raw.githubusercontent.com/bob-qoo/X-MILI-ARM/main/install.sh)
```
...
```bash
bash <(curl -Ls https://raw.githubusercontent.com/bob-qoo/X-MILI-ARM/main/install-docker.sh)
```
